...
public class UserAuthorityExample {
    ...
    public UserAuthorityExample sumId() {
        this.sumCol="id";
        return this;
    }

    public UserAuthorityExample sumUserId() {
        this.sumCol="user_id";
        return this;
    }

    public UserAuthorityExample sumAuthorityId() {
        this.sumCol="authority_id";
        return this;
    }
    ...
    public UserAuthorityExample page(int offset, int limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
